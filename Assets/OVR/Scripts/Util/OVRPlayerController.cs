...
public class OVRPlayerController : MonoBehaviour
{
    ...
    {
        blinder.SetActive(activate);
    }

    private void initOurCode()
    {
        musicPlayer = transform.Find("OVRCameraRig").Find("TrackingSpace").Find("CenterEyeAnchor").Find("MusicSource").GetComponent<AudioSource>();
        blinder = transform.Find("OVRCameraRig").Find("TrackingSpace").Find("CenterEyeAnchor").Find("Blinder").gameObject;
